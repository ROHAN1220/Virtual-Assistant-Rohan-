...
function takeCommand(message) {
    ...
    else if (message.includes("open age calculator")){
        window.open("https://age-calculator-two-ashy.vercel.app/","_blank");
        speak("Opening age Calculator")
    }


    else if (message.includes("open watch stop")){
        window.open("https://stop-watch-amber-eight.vercel.app/", "_blank");
        speak("Opening Stop Watch")
    }
    else if (message.includes("database register")){
        window.open("http://localhost:8080/rohan/dataform/register.php", "_blank");
        speak("Opening Database Register")
    }
    
    else if (message.includes("open loan calculator")){
        window.open("https://loan-calculator-eight-gamma.vercel.app/", "_blank");
        speak("Opening Loan Calculator")
    }

    else if (message.includes(" contact form")){
        window.open("http://localhost:8080/rohan/dataform/index.html.php", "_blank");
